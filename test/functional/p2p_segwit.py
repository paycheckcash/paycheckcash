...
class SegWitTest(PaycheckCashTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older paycheckcashd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let paycheckcashd fill it in.
