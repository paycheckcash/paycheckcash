...
# TestP2PConn: A peer we use to send messages to paycheckcashd, and store responses.
...
class CompactBlocksTest(PaycheckCashTestFramework):
    ...
    # This test actually causes paycheckcashd to (reasonably!) disconnect us, so do this last.
    ...
    # paycheckcashd's choice of nonce.
    ...
    # Test that paycheckcashd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for paycheckcashd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # paycheckcashd will not send blocktxn responses for blocks whose height is
