...
"""Verify that starting paycheckcash with -h works as expected."""

from test_framework.test_framework import PaycheckCashTestFramework
from test_framework.util import assert_equal

class HelpTest(PaycheckCashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start paycheckcash with -h for help text")
        ...
        self.log.info("Start paycheckcash with -version for version information")
        ...
        self.log.info("Start paycheckcashd with -fakearg to make sure it does not start")
