...
#ifndef PAYCHECKCASH_WALLET_WALLET_H
#define PAYCHECKCASH_WALLET_WALLET_H
...
public:
     ...
     * on this paycheckcash node, and set to 0 for transactions that were created
...
#endif // PAYCHECKCASH_WALLET_WALLET_H
