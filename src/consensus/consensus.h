...
#ifndef PAYCHECKCASH_CONSENSUS_CONSENSUS_H
#define PAYCHECKCASH_CONSENSUS_CONSENSUS_H
...
// version. The former uses PaycheckCash parameters, but if this fork is a fork
...
#endif // PAYCHECKCASH_CONSENSUS_CONSENSUS_H
