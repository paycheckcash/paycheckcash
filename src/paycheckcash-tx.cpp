...
static void SetupPaycheckCashTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " paycheckcash-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  paycheckcash-tx [options] <hex-tx> [commands]  Update hex-encoded paycheckcash transaction\n" +
                               "or:     paycheckcash-tx [options] -create [commands]   Create hex-encoded paycheckcash transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paycheckcash transaction
