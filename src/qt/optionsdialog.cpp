                                                                   ...
                                                                   mapper(0)
{
    ...
    ui->paycheckcashAtStartup->setToolTip(ui->paycheckcashAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->paycheckcashAtStartup->setText(ui->paycheckcashAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openPaycheckCashConfButton->setToolTip(ui->openPaycheckCashConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PaycheckCashUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->paycheckcashAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPaycheckCashConfButton_clicked()
{
    ...
    if (!GUIUtil::openPaycheckCashConf())
