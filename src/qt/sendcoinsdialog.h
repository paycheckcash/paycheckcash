...
#ifndef PAYCHECKCASH_QT_SENDCOINSDIALOG_H
#define PAYCHECKCASH_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending paycheckcashs */
...
#endif // PAYCHECKCASH_QT_SENDCOINSDIALOG_H
