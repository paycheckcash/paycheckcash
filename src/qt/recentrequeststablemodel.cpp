    ...
    if (role == Qt::DisplayRole || role == Qt::EditRole) {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return PaycheckCashUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, PaycheckCashUnits::separatorNever);
            else
                return PaycheckCashUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " (" + PaycheckCashUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
