...
#ifndef PAYCHECKCASH_INTERFACES_NODE_H
#define PAYCHECKCASH_INTERFACES_NODE_H
...
//! Top-level interface for a paycheckcash node (paycheckcashd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PAYCHECKCASH_INTERFACES_NODE_H
