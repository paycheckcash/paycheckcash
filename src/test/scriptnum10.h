...
#ifndef PAYCHECKCASH_TEST_SCRIPTNUM10_H
#define PAYCHECKCASH_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from PaycheckCash Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PAYCHECKCASH_TEST_BIGNUM_H
