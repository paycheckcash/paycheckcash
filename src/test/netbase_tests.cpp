...
{
    BOOST_CHECK(TestSplitHost("www.paycheckcashcore.org", "www.paycheckcashcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.paycheckcashcore.org]", "www.paycheckcashcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.paycheckcashcore.org:80", "www.paycheckcashcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.paycheckcashcore.org]:80", "www.paycheckcashcore.org", 80));
