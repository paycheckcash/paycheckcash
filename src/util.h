 ...
 */
#ifndef PAYCHECKCASH_UTIL_H
#define PAYCHECKCASH_UTIL_H
...
extern const char* const PAYCHECKCASH_CONF_FILENAME;
extern const char* const PAYCHECKCASH_PID_FILENAME;
...
{
    std::string s = strprintf("paycheckcash-%s", name);
