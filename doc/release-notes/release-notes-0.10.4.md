PaycheckCash Core version 0.10.4 is now available from:

  <https://paycheckcash.org/bin/paycheckcash-core-0.10.4/>
...
- #6953 `43c2789` Split paycheckcash-tx into its own package
- #6953 `dfe0d4d` Include paycheckcash-tx binary on Debian/Ubuntu
