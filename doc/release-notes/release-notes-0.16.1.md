PaycheckCash Core version 0.16.1 is now available from:

  <https://paycheckcashcore.org/bin/paycheckcash-core-0.16.1/>
...
- #12843 `df38b13` Test starting paycheckcashd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure paycheckcashd processes are cleaned up when tests end (sdaftuar)
