PaycheckCash Core version 0.13.2 is now available from:

  <https://paycheckcash.org/bin/paycheckcash-core-0.13.2/>
...
- #8908 `4a974b2` Update paycheckcash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow paycheckcash-tx to create v2 transactions (btcdrak)
