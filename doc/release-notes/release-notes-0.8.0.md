PaycheckCash-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/paycheckcash/files/PaycheckCash/paycheckcash-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the PaycheckCash
...
New/changed settings (command-line or paycheckcash.conf file)
--------------------------------------------------------
