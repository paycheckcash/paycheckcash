PaycheckCash Core version 0.9.2.1 is now available from:

  https://paycheckcash.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PCC to 0.01 PCC
...
- Fix "Start paycheckcash on system login"
