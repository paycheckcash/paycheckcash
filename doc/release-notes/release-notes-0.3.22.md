Download URL: https://sourceforge.net/projects/paycheckcash/files/PaycheckCash/paycheckcash-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PCC fee schedule (users still pay 0.01 PCC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #paycheckcash00 - #paycheckcash99
