PaycheckCash Core version 0.9.4 is now available from:

  https://paycheckcash.org/bin/0.9.4/
...
this update is incompatible with the PaycheckCash system and could lead to consensus
forks.

PaycheckCash Core released binaries from https://paycheckcash.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~paycheckcash/+archive/ubuntu/paycheckcash
- A third-party or self-compiled PaycheckCash Core

upgrade to PaycheckCash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
